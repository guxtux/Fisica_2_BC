...
\begin{frame}
\frametitle{Resolviendo el ejercicio}
\textocolor{red}{Datos:} \pause V =\SI{120}{\volt}, \quad I = \SI{3}{\ampere}
\\
\bigskip
\pause
\textocolor{red}{Expresión:}
...
\begin{frame}
\frametitle{Resolviendo el ejercicio}
\textocolor{red}{Datos:} \pause R =\SI{35}{\ohm}, \quad I = \SI{4}{\ampere}
\\
\bigskip
\pause
\textocolor{red}{Expresión:}
...
\pause
\setbeamercolor{item projected}{bg=darkgreen,fg=white}
\setbeamertemplate{enumerate items}{%
\usebeamercolor[bg]{item projected}%
\raisebox{1.5pt}{\colorbox{bg}{\color{fg}\footnotesize\insertenumlabel}}%
}
...
El \textocolor{red}{calor} que produce una \textocolor{ao}{corriente eléctrica} al circular por un conductor
\pause es directamente proporcional al cuadrado de la intensidad de la corriente, a la \textocolor{cadmiumgreen}{resistencia} y al \textocolor{byzantine}{tiempo} que dura circulando la corriente.
\end{frame}
\begin{frame}
